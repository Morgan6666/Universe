...
from chat.serializers import serialize_message_model, serialize_dialog_models, serialize_file_model
...
class SerializerTest(TestCase):
    ...
    def test_serialize_dialog_model(self):
        serialized = serialize_dialog_models(self.dialog, self.sender.pk)
        o = {
            'id': self.dialog.id,

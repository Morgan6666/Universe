    ...
    def test_update_user_success(self):
        ...
        client.post('/api-user/create/',
                    {'full_name': 'Test User A',
                     ...
                     'email': 'testusera@gmail.com',
                     'password': 'test1user1a'})
        response = client.patch('/api-user/update/1/',
    ...
    def test_delete_user_success(self):
        ...
        client.post('/api-user/create/',
                    {'full_name': 'Test User A',
                     ...
                     'email': 'testusera@gmail.com',
                     'password': 'test1user1a'})
        response = client.post('/api-user/delete/1/', {'password': 'test1user1a'})
    ...
    def test_delete_user_failure_password(self):
        client.post('/api-user/create/',
                    {'full_name': 'Test User A',
                     ...
                     'email': 'testusera@gmail.com',
                     'password': 'test1user1a'})
        response = client.post('/api-user/delete/1/', {'password': 'a_wrong_password'})
        self.assertEqual(response.status_code, 203)
    ...
    def test_delete_user_failure_pk(self):
        client.post('/api-user/create/',
                    {'full_name': 'Test User A',
                     ...
                     'email': 'testusera@gmail.com',
                     'password': 'test1user1a'})
        response = client.post('/api-user/delete/2/', {'password': 'test1user1a'})
        self.assertEqual(response.status_code, 203)
...
class FollowUserTest(TestCase):
    ...
    def test_follow_user_success(self):
        ...
        response = client.get('/api-user/follow/1/2/')
        self.assertEqual(response.status_code, 200)
    ...
    def test_follow_user_failure(self):
        ...
        client.post('/create/',
                    {'full_name': 'Test User B',
                     ...
                     'email': 'testuserb@gmail.com',
                     'password': 'test1user1b'})
        response = client.get('/api-user/follow/4/2/')
    ...
    def test_res_data(self):
        ...
        client.post('/api-user/create/',
                    {'full_name': 'Test User A',
                     ...
                     'email': 'testusera@gmail.com',
                     'password': 'test1user1a'})
        response = client.get('/api-user/get/1/')
        expected_data = {
            'pk': 1,
            'full_name': 'Test User A',
            'email': 'testusera@gmail.com',
